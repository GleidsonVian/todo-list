...
def adicionar_item_tarefa(tarefa):
    ...
    label_tarefa.pack(side=tk.LEFT, fill='x', padx=10, pady=5)

    botao_editar = tk.Button(frame_tarefa, image=icon_editar, command=lambda f=frame_tarefa, l=label_tarefa: preparar_edicao(f, l), bg='white', relief='flat')
    botao_editar.pack(side='right', padx=5)

    botao_deletar = tk.Button(frame_tarefa, image=icon_deletar, command=lambda f=frame_tarefa: deletar_tarefa(f), bg='white', relief='flat')
...
# Carregar ícones
icon_editar = PhotoImage(file=r'C:\Users\gleid\pasta4\Python\Projetos Guiados\aplicativo de tarefas em Python todo app em python\editar-azul.png').subsample(19, 19)
icon_deletar = PhotoImage(file=r'C:\Users\gleid\pasta4\Python\Projetos Guiados\aplicativo de tarefas em Python todo app em python\lixeira.png').subsample(19, 19)
...
# Criar frame para entrada de tarefas
...
# Criar frame para a lista de tarefas com rolagem
